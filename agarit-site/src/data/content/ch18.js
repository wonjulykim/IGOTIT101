export const ch18 = {
  'ch18-1': {
    ...
    blocks: [
      ...
      {
        type: 'p',
        text: '영어에서 see, hear, feel, watch, notice, observe처럼 이러한 지각 활동을 표현하는 동사를 지각동사라고 합니다. 지각동사는 「지각동사 + 목적어 + 동사원형」의 5형식 구조로 쓰이며, 목적격 보어 자리에는 동사원형이 옵니다.',
      },
      {
        type: 'note',
      ...
      {
        type: 'note',
        text: '17장에서 사역동사(make, have, let)가 목적격 보어로 동사원형을 취하는 이유는, 시키는 행위와 시킴을 받아 하는 행위가 동시에 일어나기 때문이었습니다. 지각동사도 원리는 같습니다. 지각동사를 통해 인식한 행위(노래하는 것을 봄)와 목격된 행위(노래를 부름)가 동시에 일어나기 때문에, 목적격 보어에 별도의 시제를 표시할 필요가 없습니다. 시제는 이미 앞의 지각동사(saw, heard, felt)에 표현되어 있습니다. 즉, 사역동사와 지각동사가 똑같이 「동사 + 목적어 + 동사원형」 구조를 쓰는 것은 우연이 아니라, 두 동사 모두 목적격 보어의 동작이 주어의 동사와 동시에 일어난다는 공통된 의미 원리를 공유하기 때문입니다.',
      },
      {
        type: 'example',
        items: [
      ...
      {
        type: 'p',
        text: '지각동사와 자주 혼동되는 것이 감각동사입니다. 감각이란 눈, 코, 귀, 혀, 살갗을 통하여 바깥의 어떤 자극을 알아차리는 행위이고, 지각은 그 감각을 통한 인지입니다. 감각동사(feel, taste, smell, sound, look 등)는 주어의 상태나 느낌을 표현하며 「감각동사 + 형용사」 구조로 쓰입니다. 감각동사는 주어가 어떻게 느끼는지, 어떤 상태인지, 또는 어떻게 보이는지를 나타내며, 형용사를 사용해 주어를 보충 설명합니다. 반면 지각동사(see, hear, watch, notice, observe 등)는 주어가 외부의 동작이나 상태를 감각을 통해 인식하는 것을 표현하며 「지각동사 + 목적어 + 동사원형」 구조로 쓰입니다.',
      },
      {
        type: 'example',
        items: [
      ...
      {
        type: 'p',
        text: '위에서 feel이 감각동사로 쓰이면 「feel + 형용사」로 주어 자신의 느낌을 나타내지만(She feels tired.), 지각동사로 쓰이면 「feel + 목적어 + 동사원형」으로 외부 대상의 동작을 감지했다는 뜻이 됩니다(I felt something touch my back.). 같은 동사라도 구조에 따라 의미가 달라진다는 점에 주의해야 합니다.',
      },
      {
        type: 'table',
