export const ch12 = {
  'ch12-1': {
    ...
    blocks: [
      ...
      {
        type: 'p',
        text: '길을 지나가다 멋진 자동차를 보았을 때 느낀 감탄을 표현하는 여러 방법을 통해 What 감탄문이 어떻게 만들어지는지 단계별로 살펴봅시다. 출발점은 아주 평범한 평서문 "It is a nice car."입니다.',
      },
      {
        type: 'transform',
        from: { label: '1단계 · 평서문', text: 'It is a nice car!' },
      ...
      {
        type: 'note',
        text: '감탄문은 반드시 말하는 사람과 듣는 사람이 상황을 공유하는 맥락 안에서 쓰입니다. What은 단순한 감탄사가 아니라 그 공유된 상황 전체를 받는 역할을 합니다. 상대방이 상황을 모르는 채로 "What a nice car it is!"라고만 말하면 상대방은 의미를 이해하지 못합니다.',
      },
      ...
      {
        type: 'p',
        text: '주어-동사(she is)는 감탄문의 핵심이 아니라 "누가 그런지"를 알려주는 부가 정보에 가깝습니다. 감탄의 핵심은 how 뒤에 오는 형용사·부사이므로, 그 대상이 문맥에서 충분히 유추되면 주어-동사는 자연스럽게 생략됩니다.',
      },
      ...
      {
        type: 'note',
        text: '"What a nice day!", "How nice!"처럼 주어-동사가 전혀 없는 짧은 감탄사는 대화에서 매우 흔히 쓰이는 구어체 표현입니다. 이런 표현들은 굳이 "it is"나 "that is"를 채워 넣지 않아도 관용적으로 통용되며, 오히려 완전한 문장을 매번 쓰면 부자연스럽게 들릴 수 있습니다.',
      },
      ...
      {
        type: 'note',
        text: '정리하면 두 가지 실수가 대표적입니다. (1) What 감탄문에서 단수 가산명사 앞에 a/an을 빠뜨리는 것, (2) How 감탄문에서 명사를 형용사와 함께 앞으로 끌고 가버려 "How + 형용사 + 명사" 형태로 잘못 만드는 것입니다. How는 형용사·부사만 강조하므로 명사는 절대 How 바로 뒤에 붙을 수 없다는 점을 기억하세요.',
      },
