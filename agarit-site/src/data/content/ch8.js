export const ch8 = {
  'ch8-1': {
    ...
    blocks: [
      ...
      {
        type: 'icon-row',
        caption: '시간(time)과 시제(tense)는 서로 다르다',
        items: [
          { icon: '🌍', label: '시간(time)', sub: '실제로 존재하는 흐름' },
          { icon: '📝', label: '시제(tense)', sub: '동사 형태로 표시하는 문법 장치' },
        ],
      },
      {
        type: 'example',
      ...
      {
        type: 'icon-row',
        caption: '시제를 고르는 세 가지 질문',
        items: [
          { icon: '1️⃣', label: '언제?', sub: '현재 · 과거 · 미래' },
          { icon: '2️⃣', label: '점 vs 진행', sub: '사실인가, 펼쳐지는 동작인가' },
          { icon: '3️⃣', label: '완료 여부', sub: '영향·결과가 남아 있는가' },
        ],
      },
      {
        type: 'note',
