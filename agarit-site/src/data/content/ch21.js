export const ch21 = {
  'ch21-1': {
    ...
    blocks: [
      {
        type: 'p',
        text: '영어 동사에는 시제(tense) 외에 상(aspect)이라는 개념도 있습니다. 시제는 "언제" 일어난 일인지를 나타내고, 상은 그 동작이 "진행 중인지, 끝났는지"를 나타냅니다. 동사의 현재시제는 일반적 사실이나 반복되는 행동, 습관을 나타내지만, 현재진행형은 지금 이 순간 진행 중인 행동을 나타냅니다. 이렇게 **동작이 진행 중이면 진행상, 동작이 끝났으면 완료상**이라고 부릅니다. 이번 장에서는 일의 끝남 또는 지속을 나타내는 완료 표현을 배웁니다.',
      },
      {
        type: 'example',
        items: [
      ...
      {
        type: 'p',
        text: '현재완료 문장은 대부분 **"과거에 일어난 일 + 그로 인한 현재 상태"라는 두 가지 의미를 한 문장에 압축한 것**으로 풀어 쓸 수 있습니다.',
      },
      {
        type: 'example',
        items: [
      ...
      {
        type: 'note',
        text: 'since + 과거 시점("그때부터 지금까지")과 for + 기간("~동안")은 현재완료와 자연스럽게 어울리지만, **yesterday·last week·in 2020·ago처럼 사건을 과거의 한 점에 고정하는 표현은 현재완료와 함께 쓸 수 없다**는 점을 반드시 기억해야 합니다.',
      },
      { type: 'heading', text: '현재완료의 네 가지 의미' },
      {
        type: 'p',
        text: '현재완료는 문맥에 따라 **계속, 경험, 완료, 결과라는 네 가지 의미**로 쓰입니다. 형태는 모두 "have/has + p.p."로 같지만, 함께 쓰이는 부사(since, for, ever, just, already, yet 등)와 문맥에 따라 의미가 달라집니다. 아래에서 네 가지 의미를 하나씩, 각각의 시간축 그림과 함께 살펴봅시다.',
      },
      {
        type: 'table',
      ...
      {
        type: 'p',
        text: '"계속"의 현재완료는 **과거의 한 시점에서 시작된 상태나 동작이 끊어지지 않고 지금까지 이어지고 있음**을 나타냅니다. for(~동안)나 since(~부터) 같은 부사(구)와 자주 쓰입니다.',
      },
      {
        type: 'timeline',
  ...
  'ch21-2': {
    ...
    blocks: [
      {
        type: 'p',
        text: '현재완료진행은 **과거에 시작된 동작이 현재까지 계속되고 있음을 나타내는 시제**입니다. 현재완료(계속적 용법)와 비교하면 거의 차이가 없어 보이지만, 강조하는 초점이 다릅니다.',
      },
      {
        type: 'note',
      ...
      {
        type: 'p',
        text: '"I have been studying English for 20 years."는 일의 시작-진행-끝(현재) 전체에서 **특히 "진행 중임"에 초점**을 둡니다. 반면 "I have studied English for 20 years."는 같은 기간을 나타내지만 **진행 과정보다는 지금까지의 결과·경험 자체에 초점**을 둡니다.',
      },
      {
        type: 'timeline',
  ...
  'ch21-3': {
    ...
    blocks: [
      ...
      {
        type: 'p',
        text: '과거완료 시제는 **과거의 특정 시점보다 이전에 완료된 동작이나 상태를 나타낼 때 사용**합니다. 과거에 일어난 두 사건을 모두 과거시제로만 표현하면, 두 사건이 순차적으로 일어났을 때 무엇이 먼저 일어났는지 정확히 파악하기 어렵기 때문에 과거완료가 필요합니다.',
      },
      {
        type: 'example',
        items: [
