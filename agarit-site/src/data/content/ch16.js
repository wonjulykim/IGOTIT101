export const ch16 = {
  'ch16-1': {
    ...
    blocks: [
      ...
      {
        type: 'p',
        text: '4형식을 3형식으로 바꿀 때 모든 동사가 같은 전치사를 쓰는 것은 아닙니다. 동사의 의미에 따라 사용되는 전치사도 달라집니다. 전치사 to는 단순한 물건의 이동을 나타내므로 ‘전달’의 의미를 가진 동사에 쓰이고, 전치사 for는 무엇인가를 주기 위해 정성과 노력, 시간, 돈 등이 들어간 동사에 쓰여 받는 사람을 위한 정성과 노력을 나타냅니다.',
      },
      {
        type: 'table',
      ...
      {
        type: 'note',
        text: 'to는 물건이 단순히 사람에게 옮겨가는 것만을 나타내지만, for는 그 물건을 준비하는 데 들어간 정성·노력·시간·돈까지 함께 나타냅니다. 그래서 make, cook, buy처럼 무언가를 만들거나 마련해서 주는 동사들은 for를 사용합니다.',
      },
