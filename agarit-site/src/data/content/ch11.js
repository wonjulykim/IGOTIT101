export const ch11 = {
  'ch11-1': {
    ...
    blocks: [
      {
        type: 'p',
        text: '명령문은 상대방에게 어떤 행동을 지시하거나 요청하는 문장입니다. 명령문은 우리가 지금까지 배운 문장과 다른 점이 있는데, 바로 주어 없이 동사원형으로 문장을 시작한다는 것입니다. 동사원형이란 시제가 없는 동사의 기본 형태를 말합니다. 이 장에서는 명령문이 왜 이런 독특한 형태를 갖는지, 그리고 실제 상황 속에서 어떻게 쓰이는지를 문맥을 통해 하나씩 확인해 보겠습니다.',
      },
      {
        type: 'example',
        items: [
      ...
      {
        type: 'p',
        text: '명령문 문장만 따로 떼어놓고 보면 "왜 주어 없이 동사원형으로 시작하는가?"를 이해하기 어렵습니다. 명령문을 이해하려면 반드시 문맥(상황)이 필요합니다. 예를 들어 원준이가 방문을 열어놓고 책을 읽고 있었는데, 동생이 방에 들어오면서 문을 닫았다고 해봅시다. 이때 원준이는 동생에게 "Open the door!"라고 말합니다. 이 상황에서는 문맥을 통해 "문을 열어라"라고 말하는 대상이 동생, 즉 듣는 사람(You)이라는 것을 누구나 알 수 있습니다.',
      },
      {
        type: 'p',
