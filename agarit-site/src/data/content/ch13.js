export const ch13 = {
  'ch13-1': {
    ...
    blocks: [
      ...
      {
        type: 'p',
        text: '이 자유가 바로 to부정사가 명사·형용사·부사라는 세 가지 역할을 모두 해낼 수 있는 근본 원리입니다. 추상적 개념은 명사처럼 이름 붙여 가리킬 수도 있고(주어·목적어·보어 자리에서 ‘연주하는 것’), 형용사처럼 다른 명사를 꾸며 그 명사의 용도나 목적을 설명할 수도 있고(‘연주할 시간’), 부사처럼 다른 동작이나 상태가 일어난 이유·목적·결과를 설명할 수도 있습니다(‘연주하기 위해’). 품사가 셋으로 늘어나는 것이 아니라, 하나의 추상적 개념이 문장의 세 가지 빈자리(명사 자리, 형용사 자리, 부사 자리) 중 어디에 놓이느냐에 따라 다른 역할처럼 보이는 것뿐입니다.',
      },
      {
        type: 'table',
      ...
      {
        type: 'p',
        text: '앞의 세 문장(want, decided, is 뒤)에서는 to부정사가 목적어·보어처럼 명사 역할을 했고, 지금 다섯 문장에서는 형용사·부사 역할을 하고 있습니다. 역할은 이렇게 다양하지만, to부정사가 그리는 큰 그림은 언제나 같습니다. 바로 「to + 동사원형」 쪽으로 무엇인가를 이루기 위해 향해 가는 모습입니다.',
      },
      {
        type: 'table',
      ...
      {
        type: 'p',
        text: 'to부정사는 전치사 to의 모양을 동사원형 앞에 붙여, 동사를 명사·형용사·부사로 바꾸어주는 장치입니다. 동사의 모양을 그대로 유지하면서 품사만 바꾸기 때문에, 동사가 원래 가지고 있던 목적어나 수식어를 그대로 데리고 올 수 있습니다. 그래서 훨씬 풍부하고 다양한 의미의 명사, 형용사, 부사를 만들어 낼 수 있습니다.',
      },
      {
        type: 'example',
        items: [
      ...
      {
        type: 'p',
        text: 'to부정사와 동명사(-ing)는 둘 다 동사에서 시제를 떼어내 만든 추상적 개념이라는 점에서 비슷하지만, to부정사는 앞으로 향해 갈 미래·목표 지향적 느낌이 강하고 동명사는 이미 벌어지고 있거나 반복되는 동작 그 자체를 가리키는 느낌이 강합니다. 이 차이는 뒤의 동명사 단원에서 자세히 다루지만, 지금 단계에서는 “동사원형 앞에 to가 붙으면 무조건 to부정사”라는 형태만 정확히 기억해 두는 것이 중요합니다.',
      },
      {
        type: 'transform',
  ...
  'ch13-2': {
    ...
    blocks: [
      {
        type: 'p',
        text: 'to부정사가 나타내는 ‘그 동작을 한다는 것’이라는 추상적 개념은 명사처럼 이름을 붙여 가리킬 수 있습니다. 이렇게 to부정사가 문장에서 명사가 하는 일, 즉 주어·목적어·보어 역할을 하면 이를 to부정사의 명사적 용법이라고 합니다.',
      },
      {
        type: 'example',
        items: [
      ...
      {
        type: 'p',
        text: '목적어는 동사 뒤에서 동작의 대상을 나타냅니다. to부정사가 동사의 목적어로 쓰이면, 동사가 나타내는 행동이나 상태의 목적을 분명히 설명해주는 역할을 합니다.',
      },
      {
        type: 'sentence-diagram',
        label: '동사의 목적어',
      ...
      {
        type: 'p',
        text: '보어는 주어를 보충 설명하거나 주어의 상태를 분명히 설명해주는 역할을 합니다. ‘My goal is to finish reading this book this month.’에서 ‘to finish reading this book this month’는 보어로 쓰여, ‘내 목표가 무엇인지’를 구체적으로 설명해줍니다.',
      },
      {
        type: 'sentence-diagram',
        label: '주격보어',
      ...
      {
        type: 'p',
        text: '명사적 용법의 to부정사도 원래 동사가 데려오던 목적어를 그대로 가지고 올 수 있습니다. 그런데 학습자들은 종종 “I want study English.”처럼 to를 빠뜨리고 동사원형만 쓰는 실수를 저지릅니다. want, decide, hope, plan, agree 같은 동사들은 뒤에 동사가 또 올 때 반드시 to부정사(to + 동사원형)의 형태를 갖추어야 한다는 점을 기억해야 합니다.',
      },
      {
        type: 'transform',
  ...
  'ch13-3': {
    ...
    blocks: [
      {
        type: 'p',
        text: 'to부정사가 나타내는 추상적 개념은 명사를 꾸며 그 명사가 어떤 용도로 쓰이는지, 무엇을 위한 것인지를 설명해줄 수도 있습니다. 이렇게 to부정사가 명사 뒤에 놓여 그 명사를 꾸며주면 형용사적 용법이라고 합니다. 앞 레슨의 보어 역할과 다른 점은, 형용사적 용법의 to부정사는 앞의 명사와 동일한 것을 가리키는 게 아니라 그 명사를 수식할 뿐이라는 것입니다.',
      },
      {
        type: 'example',
        items: [
