export const ch7 = {
  'ch7-1': {
    ...
    blocks: [
      {
        type: 'p',
        text: 'be동사는 **주어와, 주어를 설명해주는 단어를 서로 연결해주는 역할**을 합니다. be동사 자체에 "~이다"라는 뜻이 있다고 외우기보다는, "주어와 주어를 설명해주는 단어를 이어주는 동사"라고 이해하는 것이 좋습니다. 왜 이런 구분이 필요한지는 아래에서 장소·신분·상태를 나타내는 다양한 문장을 통해 살펴보겠습니다.',
      },
      ...
      {
        type: 'note',
        text: '이 차이 때문에 한국어를 모국어로 쓰는 학습자는 영어로 말할 때 **be동사를 빠뜨리는 실수**를 자주 합니다. "바쁘다" 자체가 이미 서술어처럼 느껴지기 때문에, 영어에서도 습관적으로 연결 동사를 빼고 형용사만 말하게 되는 것입니다.',
      },
  ...
  'ch7-2': {
    ...
    blocks: [
      ...
      {
        type: 'p',
        text: 'like, know, believe, belong, want처럼 상태를 나타내는 일반동사는 "지금 잠깐" 벌어지는 일이 아니라 원래부터 계속 그런 상태이므로, **특별한 강조 의도가 없다면 진행형(-ing)으로 잘 쓰지 않는 경향**이 있습니다. 이 부분은 10장(시제)에서 더 자세히 다루므로, 여기서는 상태 동사에 -ing를 습관적으로 붙이지 않도록 주의한다는 정도만 기억해두면 충분합니다.',
      },
      {
        type: 'example',
        items: [
  ...
  'ch7-3': {
    ...
    blocks: [
      {
        type: 'p',
        text: '조동사는 be동사나 일반동사가 나타내지 못하는 **가능성, 능력, 허락, 의무 등을 표현해주는 동사**입니다. be동사나 일반동사를 도와준다는 뜻에서 조동사(助動詞)라고 부릅니다.',
      },
      {
        type: 'note',
      ...
      {
        type: 'p',
        text: '세 문장 모두 "미나가 온다"는 같은 내용을 말하고 있지만, 화자가 느끼는 확신의 정도는 may(가장 낮음) < can(중간) < will(가장 높음) 순으로 달라집니다. 이렇게 **조동사를 고르는 기준은 사실 여부가 아니라 화자의 판단이라는 점**을 기억해야 합니다.',
      },
      {
        type: 'icon-row',
      ...
      {
        type: 'p',
        text: 'can은 흔히 "~할 수 있다"라는 뜻으로 알고 있지만, 정확히는 **"실현 가능성이 있는 정도"를 나타내는 조동사**입니다. 이 가능성이 구체적인 상황에 따라 능력, 허가, 부탁 등의 의미로 해석됩니다.',
      },
      {
        type: 'example',
        items: [
      ...
      {
        type: 'p',
        text: 'may는 흔히 "~해도 된다", "~일지도 모른다"로 해석하지만, 모든 상황에 폭넓게 적용하려면 **"(강제성 없이) 선택할 수 있는 상황"에서 쓰이는 조동사**로 이해하는 것이 좋습니다. 이 선택 가능성이 상황에 따라 허락, 부탁, 불확실한 추측의 의미로 나타납니다.',
      },
      {
        type: 'example',
        items: [
      ...
      {
        type: 'p',
        text: 'will은 **일어날 확률이나 가능성이 높은 상황**에서 쓰이는 조동사입니다. 주어의 강한 의지를 나타낼 때도, 가능성이 높은 추측을 나타낼 때도 will을 사용합니다.',
      },
      {
        type: 'example',
        items: [
