export const ch24 = {
  'ch24-1': {
    ...
    blocks: [
      ...
      {
        type: 'p',
        text: '우리는 앞서 두 문장을 이어주며 명사를 보충 설명해주는 관계대명사에 관해 배웠습니다. 관계부사도 관계대명사와 마찬가지로 비슷한 두 문장을 이어주며 앞에 있는 명사(선행사)를 설명해주는 역할을 합니다. 다만 관계대명사가 문장 안에서 명사처럼 역할을 하는 것과 달리, **관계부사는 문장 안에서 부사처럼 역할을 한다**는 점이 다릅니다. 관계부사는 주로 시간, 장소, 이유, 방법을 나타내는 선행사를 설명합니다.',
      },
      ...
      {
        type: 'p',
        text: '반면 관계부사가 쓰인 문장은 선행사가 "이미 정해진 것"이라는 전제 아래, 그 장소·시간에서 일어난 일을 부가적인 배경 설명처럼 덧붙입니다. "I knew the house where he lived."는 "나 그 집 알아. 그가 그곳에서 살았어."처럼 the house를 먼저 확정해두고, where he lived는 "그곳에서 무슨 일이 있었는지"를 부사처럼 곁들이는 느낌입니다. 즉 **관계대명사문은 선행사를 "명사로 다시 짚어 설명"하고, 관계부사문은 선행사를 "배경으로 두고 부사로 보충"한다**는 차이가 있습니다.',
      },
      {
        type: 'example',
        items: [
