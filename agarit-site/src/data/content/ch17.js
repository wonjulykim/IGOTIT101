export const ch17 = {
  'ch17-1': {
    ...
    blocks: [
      ...
      {
        type: 'p',
        text: '사역동사는 주어가 동사의 행위를 직접 한 것이 아니라, 목적어에게 어떠한 행위를 하도록 시켜서 그 행위가 일어나게 한 경우에 사용합니다. 즉 **문장 안에 ‘행위를 하는 사람(목적어)’과 ‘그 행위가 일어나게 만든 사람(주어)’이 분리**되어 있다는 점이 사역동사 구문의 핵심입니다.',
      },
      {
        type: 'example',
        items: [
      ...
      {
        type: 'p',
        text: '사역동사의 목적격 보어도 마찬가지입니다. to부정사의 to는 원래 방향이나 목표를 향해 ‘나아가는’ 이미지를 가지고 있어서, 동사와 그 행위 사이에 시간적·논리적 거리를 만듭니다. 반면 **사역동사 뒤에서는 주어가 시킨 순간과 그 행위가 일어나는 순간이 거의 겹쳐지기를 바라는 느낌이 강하기 때문에, 그 거리감을 나타내는 to조차 필요 없어져 동사원형만 남는 것**입니다.',
      },
      {
        type: 'sentence-diagram',
        label: '거리감 비교',
  ...
  'ch17-2': {
    ...
    blocks: [
      ...
      {
        type: 'p',
        text: 'get은 make, have, let과 의미상 비슷하게 ‘~하게 시키다’라는 뜻으로 쓰이지만, **목적격 보어로 동사원형이 아니라 to부정사를 취한다**는 문법적인 차이가 있습니다. get은 상대를 직접적으로 강제하기보다 ‘설득해서, 애써서 하게 만든다’는 노력의 과정이 느껴지는 동사이고, 그 과정에서 생기는 시간적 거리감이 to로 나타난다고 이해하면 자연스럽습니다.',
      },
      {
        type: 'table',
