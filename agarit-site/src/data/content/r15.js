export const r15 = {
  'r15-1': {
    ...
    blocks: [
      ...
      {
        type: 'p',
        text: 'One such person was Johannes Gutenberg. In his time, two devices were in common use: the wine press and the coin punch. One day, Gutenberg playfully asked himself, "What if I took a bunch of these coin punches and put them under the wine press so that they left images on paper?" His idea of linking these two devices led to the birth of the modern printing press.',
      },
      {
        type: 'p',
      ...
      {
        type: 'callout',
        title: '📎 핵심 문법: 「What if + 주어 + 동사」 의문문',
        items: [
          '"What if I took a bunch of these coin punches...?" → "만약 ~하면 어떨까?"라는 뜻으로, 상상이나 제안을 할 때 쓰는 표현이에요.',
          '이 문장에서는 가정의 느낌을 살리기 위해 과거형 동사(took)를 사용했어요 (가정법과 비슷한 방식).',
        ],
      },
      {
        type: 'callout',
