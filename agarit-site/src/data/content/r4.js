export const r4 = {
  'r4-1': {
    ...
    blocks: [
      ...
      {
        type: 'p',
        text: 'Artists usually sign their work to claim authorship, but what about art created by AI? Under current law, only humans can hold copyright, so the rights usually go to whoever set up the AI — the developer, the founder of the company, or the person who wrote the prompt. In large projects, however, it is often unclear who truly "arranged" the final creation.',
      },
      {
        type: 'p',
