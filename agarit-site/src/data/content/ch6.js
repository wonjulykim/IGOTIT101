  ...
  'ch6-1': {
    ...
    blocks: [
      ...
      },
      {
        ...
        rows: [
          ['단수', 'I', 'You', 'He, She, It, Tom, 손흥민, 카리나 …'],
          ['복수', 'We', 'You', 'They, Tom and Jackson …'],
        ],
      },
      {
        type: 'note',
        text: '3인칭 단수 주어와 3인칭 복수 주어에는 He, She, It, They 외에도 사람 이름이나 여러 명사가 올 수 있어 그 수가 이론상 셀 수 없이 많습니다. 반면 1인칭 단수·복수 주어는 I와 We뿐이고, 2인칭 단수·복수 주어는 You뿐입니다.',
      },
      ...
      {
        type: 'note',
        text: '과거 영어(고대 영어)에는 1인칭·2인칭·3인칭 주어 모두에 각기 다른 동사 어미(형태 변화)가 존재했습니다. 즉 지금처럼 3인칭 단수에만 특별한 표시를 하는 것이 아니라, 인칭마다 동사의 꼬리 모양이 달랐습니다. 그러나 수백 년에 걸쳐 언어가 단순화되는 과정에서 대부분의 어미가 점차 사라졌고, 유독 3인칭 단수를 표시하던 어미만 살아남아 오늘날의 -(e)s로 남게 되었습니다. 그래서 현대 영어에서는 유일하게 3인칭 단수 현재형에만 예외적으로 동사 변화가 남아 있는 것처럼 보이는 것입니다.',
      },
      {
        type: 'p',
      ...
      {
        type: 'p',
        text: '주어가 복수처럼 보이거나 여러 명을 가리키는 것처럼 느껴져도, 문법적으로는 단수로 취급되어 동사에 -s가 붙는 경우가 있습니다. 대표적으로 everyone, everybody, someone, anyone, no one과 같이 "-one/-body"로 끝나는 대명사, that과 each처럼 "하나하나"를 의미하는 표현, 그리고 family, team, class, group처럼 여러 사람을 하나의 단위로 묶어 부르는 집합명사가 있습니다.',
      },
      {
        type: 'table',
