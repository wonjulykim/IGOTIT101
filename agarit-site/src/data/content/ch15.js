export const ch15 = {
  'ch15-1': {
    ...
    blocks: [
      {
        type: 'p',
        text: '부가의문문(tag question)은 평서문 뒤에 짧게 덧붙이는 의문문으로, 내가 모르는 정보를 확인하거나 내가 이미 알고 있는 정보를 다시 확인하려는 용도로 사용됩니다. 부가의문문의 특이한 점은 긍정문 뒤에는 부정형으로, 부정문 뒤에는 긍정형으로 다시 내용을 확인한다는 것인데, 이는 단순한 문법 규칙이 아니라 "상대방에게 확인을 유도하는" 화법상의 장치입니다.',
      },
      {
        type: 'example',
        items: [
      ...
      {
        type: 'p',
        text: '한국어의 "그렇지?", "그렇지 않니?"는 원래 문장의 극성과 상관없이 늘 같은 말을 붙이지만, 영어는 반드시 반대 극성을 붙입니다. 그 이유는 부가의문문이 "이미 내가 한 말이 맞는지 상대에게 되짚어 확인시키는" 역할을 하기 때문입니다. 만약 긍정문 뒤에 또 긍정 태그를 붙인다면("She is kind, is she?") 이는 확인이 아니라 원래 문장 자체를 의심하거나 놀라는 어조로 들립니다. 반대로 반대 극성을 붙이면("She is kind, isn\'t she?") "나는 이렇게 생각하는데, 맞지?"라는 자연스러운 확인 요청이 됩니다. 즉, 반대 극성은 화자가 자신의 진술에 대해 "설마 아니겠지"라는 여지를 만들어 상대의 동의를 유도하는 장치입니다.',
      },
      {
        type: 'icon-row',
      ...
      {
        type: 'p',
        text: '부가의문문이 실제로 어떤 의도를 가지는지는 문맥(상황)을 통해 구별할 수 있습니다. 크게 세 가지 역할로 나누어 볼 수 있습니다.',
      },
      {
        type: 'p',
        text: '① 정보 확인: 대화 상대방으로부터 내가 모르는 정보를 확인하고자 할 때 사용되며, 즉각적인 답변을 기대할 수 있습니다.',
      },
      {
        type: 'example',
        items: [
      ...
      },
      {
        ...
        title: '15장 핵심 정리',
        items: [
          '부가의문문은 앞 문장이 긍정이면 부정으로, 부정이면 긍정으로 만든다. 이는 화자가 자신의 말에 "확인"의 여지를 남겨 상대의 동의나 답변을 유도하는 화법 장치이다.',
