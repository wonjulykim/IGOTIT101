  ...
  'r30-1': {
    ...
    blocks: [
      ...
      },
      {
        ...
        items: [
          '"She was so enthusiastic about learning Korean that I felt great joy in teaching her" → 「so + 형용사 + that」은 "너무 ~해서 …하다"라는 뜻으로 원인과 결과를 연결해요.',
          '"so that she could read books to her son"의 so that은 "~하기 위해서"라는 목적을 나타냅니다. (so + 형용사의 that과 헷갈리지 않도록 주의!)',
        ],
      },
      {
        type: 'callout',
