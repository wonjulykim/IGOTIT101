export const ch14 = {
  'ch14-1': {
    ...
    blocks: [
      ...
      {
        type: 'p',
        text: '동명사는 말 그대로 동사가 명사화된 것입니다. 동사원형에 to를 붙여 만든 to부정사가 "동사의 움직임 + 명사·형용사·부사의 역할"을 할 수 있었던 것처럼, 동명사도 "동사의 움직임 + 명사의 역할"을 할 수 있습니다. 동사를 명사화시켜 활용도를 높인 것입니다. to부정사와 동명사는 모두 문장에서 명사의 역할, 즉 주어·목적어·보어로 쓰일 수 있습니다.',
      },
      {
        type: 'example',
        items: [
      ...
      {
        type: 'p',
        text: '동명사와 to부정사는 둘 다 동사를 명사처럼 쓰게 해주지만, 두 형태가 완전히 같은 어감을 가지는 것은 아닙니다. to부정사의 to는 원래 "~쪽으로 향해 간다"는 방향성을 가진 전치사에서 왔기 때문에, to부정사로 표현된 동작은 "아직 도달하지 않은, 앞으로 일어날 일"의 느낌을 강하게 띱니다. 반대로 동명사는 동사에 -ing라는, 진행·경험을 나타내는 형태를 그대로 붙인 것이므로 "이미 하고 있는 일" 또는 "실제로 경험해본 일"의 느낌을 띱니다.',
      },
      {
        type: 'example',
        items: [
          { en: 'I want to learn Spanish.', ko: '나는 스페인어를 배우고 싶다.', note: 'to부정사: 아직 배우지 않았고, 앞으로 배우고 싶다는 희망' },
          { en: 'I enjoy learning Spanish.', ko: '나는 스페인어 배우는 것을 즐긴다.', note: '동명사: 지금 실제로 배우고 있는 중이며 그 과정을 즐긴다' },
        ],
      },
      {
        type: 'icon-row',
  ...
  'ch14-2': {
    ...
    blocks: [
      ...
      {
        type: 'p',
        text: 'mind(꺼려하다), enjoy(즐기다), give up(포기하다), avoid(피하다), finish(끝내다), suggest(제안하다)는 모두 이미 경험했거나 해오던 행동을 대상으로 합니다. 아직 경험하지 못한 미래의 일을 미리 꺼려하거나, 즐기거나, 포기하거나, 끝낼 수는 없기 때문입니다. 따라서 이 동사들은 "과거~현재"의 의미를 가진 동명사를 목적어로 취합니다.',
      },
      {
        type: 'table',
      ...
      {
        type: 'note',
        text: 'stop to do와 stop smoking을 혼동하면 "회의 가는 길에 담배를 끊었다"처럼 전혀 다른 뜻이 됩니다. to부정사는 목적(~하기 위해), 동명사는 중단되는 행동(~하던 것을) 이라는 구조를 기억하면 헷갈리지 않습니다.',
      },
