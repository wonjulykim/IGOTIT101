...
export default function Home() {
  const { level, xp, bestStreak, totalCorrect, unlocked } = useGame()
  ...
  return (
    <div className="home-page">
      ...
      <div className="home-stats">
        <div className="stat-box"><div className="stat-num">Lv.{level}</div><div className="stat-label">레벨</div></div>
        <div className="stat-box"><div className="stat-num">{xp}</div><div className="stat-label">누적 XP</div></div>
        <div className="stat-box"><div className="stat-num">{bestStreak}</div><div className="stat-label">최고 연속 정답</div></div>
        <div className="stat-box"><div className="stat-num">{totalCorrect}</div><div className="stat-label">누적 정답 수</div></div>
      </div>

      <h2 className="home-section-title">🏆 업적</h2>
